% Trimmed down version of click_ima_calib
map = gray(256);
figure(2);
image(I);
colormap(map);
...
if (n_sq_x1~=n_sq_x2)|(n_sq_y1~=n_sq_y2),
    disp('ERROR: Could not count the number of squares in the grid. Exiting...');
    return ;
else
    n_sq_x = n_sq_x1;
    n_sq_y = n_sq_y1;
...
fprintf(1, ['Number of Squares along X Direction: ' n_sq_x_default '\n']);
fprintf(1, ['Number of Squares along T Direction: ' n_sq_y_default '\n']);
